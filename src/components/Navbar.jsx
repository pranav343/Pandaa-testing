...
const Navbar = () => {
  ...
  return (
    <div
      ...
      className="fixed top-0 w-full z-50 flex flex-col items-center justify-center"
    >
      <nav
      ...
      >
        <div className="w-full max-w-[50rem] mx-auto backdrop-blur-lg bg-transparent  p-4 rounded-full shadow-lg">
        ...
        {isMobileMenuOpen && (
          <div className="w-full backdrop-blur-lg bg-transparent lg:hidden">
            {LINKS.map((link, index) => (
              <a
                key={index}
                href={`#${link.targetId}`}
